...
void myCars() {
  ...
  var myObj = {"name":"John","age":30,"cars": [{ "name":"Ford", "models":[ "Fiesta", "Focus", "Mustang" ] }, { "name":"BMW", "models":[ "320", "X3", "X5" ] }, { "name":"Fiat", "models":[ "500", "Panda" ] }]};
  ...
  var myObjD = JSON.decode('{"name":"John","age":30,"cars": [{ "name":"Ford", "models":[ "Fiesta", "Focus", "Mustang" ] }, { "name":"BMW", "models":[ "320", "X3", "X5" ] }, { "name":"Fiat", "models":[ "500", "Panda" ] }]}');
  print(myObjD);
...
void car(){
  print('\n------  car  ----------');
   var myObj = JSON.decode('["foo", { "name": "499", "cars": "Fiat Ford BMW" }]');
